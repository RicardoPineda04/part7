...
const CreateNew = (props) => {
  ...
  const handleSubmit = (e) => {
    ...
    props.addNew({
      ...
      url: info.inputProps.value,
      votes: 0
    })
    navigate('/')
    props.notification(`a new anecdote ${content.inputProps.value} created!`)
    setTimeout(() => {
      props.notification('')
    }, 5000)
  }
...
const App = () => {
  ...
  return (
    <div>
      ...
      <Menu anecdotes={anecdotes} addNew={addNew} anecdote={anecdote} notification={setNotification}/>
